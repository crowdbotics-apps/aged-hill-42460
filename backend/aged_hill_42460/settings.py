"""
Django settings for aged_hill_42460 project.
...
ROOT_URLCONF = 'aged_hill_42460.urls'
...
WSGI_APPLICATION = 'aged_hill_42460.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_hill_42460 API",
    "DESCRIPTION": "API documentation for aged_hill_42460 App",
    "VERSION": "v1",
}
